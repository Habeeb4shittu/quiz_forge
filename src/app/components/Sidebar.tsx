...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-0 left-0 h-full w-64 bg-gradient-to-tl from-indigo-900 via-purple-900 to-pink-900 text-white p-4 z-50 transition-transform duration-300
